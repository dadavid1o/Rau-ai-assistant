...
- Если вопрос задан о конкретной дисциплине в косвенном падеже, приведи название дисциплины к именительному падежу.
...
- возвращай название в нормальной форме, как оно должно храниться в базе
- не возвращай название в падежной форме из вопроса, если можно привести его к базовой форме
- примеры:
  - "Что изучают на Псевдодифференциальных операторах?" -> "Псевдодифференциальные операторы"
  - "Сколько кредитов у Матричного анализа?" -> "Матричный анализ"
- иначе null
